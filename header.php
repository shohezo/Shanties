...
<head prefix=”og: http://ogp.me/ns#”>
    ...
    <!-- OGP -->
    <meta property="og:url" content="https://shanties-ikesita.net/wp-admin/" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Shanties" />
    <meta property="og:description" content="名古屋の結婚式二次会・イベント| Shanties（シャンティーズ）" />
    <meta property="og:site_name" content="Shanties" />
    <meta property="og:image"
        content="https://shanties-ikesita.net/public_html/wp-content/themes/Shanties/img/LogoMark.png" />
    ...
    <header class="ly_header hp_bgc" id="header">
        <div class="ly_header_inner hp_flex hp_jcsb hp_aic">
            ...
            <div class="hp_flex hp_aic">
                <div class="el_icon">
                    <a href="https://www.instagram.com/shanties.ikeshita/" target="_blank"
                        rel="noopener noreferrer"><span>Instagram</span><img
